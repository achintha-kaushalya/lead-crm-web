    ...
    tr.innerHTML = `
      ...
      <td class="col-actions">
        <div class="action-btns">
          <button class="btn-edit" onclick="openEditPanel('${esc(lead.fcode)}')" title="Edit Lead">
          ...
          <button class="btn-del" onclick="confirmDeleteLead('${esc(lead.fcode)}')" title="Delete Lead">
